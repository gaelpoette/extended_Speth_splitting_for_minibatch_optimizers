...
optimizer = tf.keras.optimizers.SGD(learning_rate=lr/num_batches)
...
for epoch in range(epochs):
    ...
    for batch_idx, i in enumerate(range(0, len(x_train), batch_size)):
        ...
        norm_current_grad = norm_current_grad = compute_aggregator_norm(gradients)
...
metrics_df.to_csv("SpethMom_Red_Mem_batch_metrics.csv", index_label="epochs")
...
fig.tight_layout()
fig.savefig("SpethMom_Red_Mem_loss_accuracy_plot.png", dpi=300)
plt.show()
